...
import pw.thedrhax.mosmetro.authenticator.providers.FreewifizonaSbbRs;
...
public abstract class Provider extends LinkedList<Task> implements Task {
    ...
    protected static List<String> getDnsCheckDomains(Context context) {
        ...
        result.add("freewifizona.sbb.rs");
    ...
    @NonNull public static Provider find(Context context, HttpResponse response) {
        ...
        else if (FreewifizonaSbbRs.match(response)) return new FreewifizonaSbbRs(context, response);
